...
print("experiment 1. Deep Q learning step_size 32, max_Steps 6 continue until dies 0 ")
name=deep_q_learning_train(num_episodes=4000,learning_rate=0.00001,update_target_freq=120,validate_freq=2000,max_steps=6,
                                                                                    step_size=32,continue_until_dies=0)
print("result: {}".format(name))
...
print("experiment 2. Deep Q learning step_size 32, max_Steps 6 continue until dies 0 alexnet")
name=deep_q_learning_train(num_episodes=4000,learning_rate=0.00001,update_target_freq=120,validate_freq=2000,max_steps=6,
                                                                                    step_size=32,continue_until_dies=0,model_name="alexnet")
print("result: {}".format(name))

print("experiment 3. Deep Q learning step_size 32, max_Steps 6 continue until dies 0 mobilenet")
name=deep_q_learning_train(num_episodes=4000,learning_rate=0.00001,update_target_freq=120,validate_freq=2000,max_steps=6,
                                                                                    step_size=32,continue_until_dies=0,model_name="mobilenet")
print("result: {}".format(name))