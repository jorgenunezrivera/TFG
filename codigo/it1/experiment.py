...
print("experiment 1. Deep Q learning step_size 32, max_Steps 6 continue until dies 1 pretrained_mobilenet")
...
print("experiment 2. Reinforce step_size 32, max_Steps 6 continue until dies 1 alexnet")
name=reinforce_train(num_episodes=12000,learning_rate=0.0000001,validate_freq=6000,max_steps=6,
